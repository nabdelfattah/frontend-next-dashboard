      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          <div onClick={toggleDropdown}  className="w-full">
            <div className="mb-2 flex h-11 rounded-lg border border-input bg-input-background py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring">
              <div className="flex flex-wrap flex-auto gap-2">
                {selectedValuesText.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex flex-row-reverse flex-auto">
                        <div
                          ...
                          className="pl-2 text-muted-foreground cursor-pointer group-hover:text-gray-400"
                        >
                          <svg
                  ...
                  <input
                    ...
                    className="w-full h-full p-1 pr-2 text-sm bg-transparent border-0 outline-hidden appearance-none text-foreground focus:border-0 focus:outline-hidden focus:ring-0"
                    readOnly
                    value="Select option"
                  />
                )}
          ...
          {isOpen && (
            <div
              className="absolute left-0 z-40 w-full overflow-y-auto bg-surface rounded-lg shadow-sm top-full max-h-select"
            ...
            >
              <div className="flex flex-col">
                {options.map((option, index) => (
                  <div key={index}>
                    <div
                      className={`hover:bg-primary/5 w-full cursor-pointer rounded-t border-b border-border`}
