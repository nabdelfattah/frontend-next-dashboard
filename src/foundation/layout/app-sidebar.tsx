...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 start-0 bg-surface border-border text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-e
        ${
